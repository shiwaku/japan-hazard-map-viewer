...
2. 破堤点を選ぶと、破堤からの経過時間ごとの浸水範囲が表示されます。選び方は3通りあります
   - 地図上の点をクリック
   - 「最大浸水の破堤点を選ぶ」ボタン（その地点に最大の浸水をもたらす破堤点）
   - パネルのセレクト（河川で絞り込んでから一覧から選ぶ。数百件返ることがあるため）
...
**浸水ナビが扱うのは洪水（河川の想定破堤）のみです。** 浸水ナビ本体には津波・高潮の枠組みもありますが、
